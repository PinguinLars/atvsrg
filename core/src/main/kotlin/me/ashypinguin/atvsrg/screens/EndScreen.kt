    ...
    game.withRenderer(Filled) {
      ...
      when (rank) {
        SS -> {
          ...
          rect(
            actualLeftBorder - worldHeight * .1f,
            worldHeight * .575f,
            worldHeight * (.1f + .125f / 2f),
            worldHeight * .125f
          )
          ...
          arc(
            actualLeftBorder + worldHeight * (.125f / 2f),
            worldHeight * (.575f + .125f / 2f),
            worldHeight * (.125f / 2f),
            90f, 180f, ROUNDING_SEGMENTS
          )
          ...
          rect(
            rightBorder - worldHeight * (.125f / 2f),
            worldHeight * .35f,
            worldHeight * (.1f + .125f / 2f),
            worldHeight * .125f
          )
          ...
          arc(
            rightBorder - worldHeight * (.125f / 2f),
            worldHeight * (.35f + .125f / 2f),
            worldHeight * (.125f / 2f),
            270f, 180f, ROUNDING_SEGMENTS
          )
          arc(
            leftBorder + worldHeight * (.125f / 2f),
            worldHeight * (.575f + .125f / 2f),
            worldHeight * (.125f / 2f),
            90f, 180f, ROUNDING_SEGMENTS
          )
